...
##*
## EDIT: Use the sedrunner command to update the version number in any file
## NOTE: Only needed for RAPIDS projects
# RTD update
sed_runner 's/version = .*/version = '"'${NEXT_SHORT_TAG}'"'/g' docs/|<project>|/source/conf.py
sed_runner 's/version = .*/version = '"'${NEXT_SHORT_TAG}'"'/g' docs/|<project>|/source/conf.py
##*
